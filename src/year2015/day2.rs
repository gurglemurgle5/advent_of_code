...
mod tests {
    ...
    #[test]
    fn test_2x3x4() {
        assert_eq!(Day2::init("2x3x4".into()).part1(), "58");
        assert_eq!(Day2::init("2x3x4".into()).part2(), "34");
    }

    #[test]
    fn test_1x1x10() {
        assert_eq!(Day2::init("1x1x10".into()).part1(), "43");
        assert_eq!(Day2::init("1x1x10".into()).part2(), "14");
    }
}
